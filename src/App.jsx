                    ...
                    <div className="grid grid-cols-1 gap-4">
                        <div>
                            ...
                            <input
                                required
                                type="text"
                                className="w-full px-3 py-2 border border-gray-300 rounded-lg focus:outline-none focus:ring-2 focus:ring-red-500 text-sm text-gray-900"
...
const AdminView = ({ setView, handleScan, scanResult, setScanResult, database }) => {
    ...
    return (
        <div className="max-w-md mx-auto bg-gray-900 text-white min-h-screen p-4">
            ...
            {scanResult && (
                <div className={`p-6 rounded-xl text-center animate-bounce-short mb-6 shadow-2xl border-4 ${scanResult.status === 'valid' ? 'bg-green-800 border-green-600' :
